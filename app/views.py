...
code = [
    ...
    {'label': "Korea, Democratic PeopleS Republic of", 'code': "KP"},
    {'label': "Korea, Republic of", 'code': "KR"},
    {'label': "Kuwait", 'code': "KW"},
    {'label': "Kyrgyzstan", 'code': "KG"},
    {'label': "Lao PeopleS Democratic Republic", 'code': "LA"},
...
@api_view(['GET'])
def User_view_api(requests):
    users = models.LEI_user.objects.all()
    serializer = UserSerializer(users,many=True)
    return Response(serializer.data)


class create_lei_user(generics.ListCreateAPIView):
    queryset = models.LEI_user.objects.all()
    ...
    def create(self, request, *args, **kwargs):
        ...
        company_name=serializer.data['entity_name']
        company_number = serializer.data['company_number']
        legal_code = serializer.data['country']
        first_name = serializer.data['applicant_first_name']
        last_name = serializer.data['applicant_last_name']
        response = create_LEI(
            companyName=company_name,
            companyNumber=company_number,
            legalJurisdiction=legal_code,
            firstName=first_name,
            lastName=last_name
        )
        # create_LEI(companyName=)
        response = f'{serializer.data}\n{response}'
        return Response(response, status=status.HTTP_201_CREATED, headers=headers)
def create_LEI(companyName,companyNumber,legalJurisdiction,firstName,lastName):
    url = "https://api.rapidlei.com/v1/leis/orders/create"
    payload = json.dumps({
        "companyName": f"{companyName}",
        "companyNumber": f"{companyNumber}",
        "legalJurisdiction": f"{legalJurisdiction}",
    ...
    headers = {
        'Authorization': 'Bearer xxxxxxPaste_Bearer_Access_Token_herexxxxxx',
...
# {'id': 13,
#  'parent_company': OrderedDict([
#      ('address',
#       [OrderedDict([
#           ('entity_address', 'TashkentCity'),
#           ('city', 'Tashkent'),
#           ('code', 160001),
#           ('is_headquarter', True)])]),
#      ('company_number', '65'),
...
#      ('to_date', '2022-06-19'),
#      ('latest_date_relation', '2022-06-19')]),
#  'address': [OrderedDict([
#      ('entity_address', 'TashkentCity'),
#      ('city', 'Tashkent'),
#      ('code', 160001),
...
#  'country': 'Алжир',
#  'applicant_full_name': 'aliyuldashev',
#  'email': 'ahsjliyuldashev880@gmail.com',
#  'entity_name': 'ali',
#  'phone': '+998888288825',
#  'company_number': '65',
#  'vat_number': '464645454545421',
#  'reason_unprovide': '',
#  'total_money': None,
#  'billing_type': None
#  }